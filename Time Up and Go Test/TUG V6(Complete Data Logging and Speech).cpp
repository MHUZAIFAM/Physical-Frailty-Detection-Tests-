                    ...
                    for (int i = 0; i < BODY_COUNT; ++i) {
                        ...
                        if (body) {
                            ...
                            if (isTracked) {
                                ...
                                if (joints[JointType_SpineMid].Position.Z <= 4.3f && joints[JointType_SpineMid].Position.Z >= 3.9f && !isTestStarted && !isTestCompleted) {
                                ...
                                if (isTestCompleted) {
                                    ...
                                    cv::putText(bgrMat, "Elapsed Time: " + std::to_string(elapsedSeconds) + "s", cv::Point(50, 500), cv::FONT_HERSHEY_COMPLEX, 1, cv::Scalar(0, 0, 0), 2);
