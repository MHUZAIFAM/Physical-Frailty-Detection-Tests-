/*This Code Has perfect visual display but needs improvement in data logging and needs speech in texxt*/
//Data Logging Should be as follows
// | Timed Up and Go Test (s) 1 | Timed Up and Go Test (s) 2 | Timed Up and Go Test (s) 3 | 
// |          12.12             |           23.54            |         12.5               |  Row is the examples 1 row denotes one person
// |          7.12              |            13.54           |         9.8                |  Coloumns is the number of times test was repeated
//
//
#include <Kinect.h>
                             ...
                             if (isTracked) {
                                ...
                                //print person detected sitting on the chair
                                 ...
                                 if (isTestCompleted) {
                                     ...
                                     // If the user enters 'n' or anything else, do not reset the flags
                                 }
