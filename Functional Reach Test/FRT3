                    ...
                    for (int i = 0; i < BODY_COUNT; ++i) {
                        ...
                        if (body) {
                            ...
                            if (isTracked) {
                                ...
                                // Calculate and print the distance of the hands from their initial positions
                                if (initialLeftHandZ != -1.0f && initialRightHandZ != -1.0f) {
                                    float leftHandDistance = std::abs(initialLeftHandZ - joints[JointType_HandLeft].Position.Z);
                                    float rightHandDistance = std::abs(initialRightHandZ - joints[JointType_HandRight].Position.Z);
                                    std::cout << "Left Hand Distance: " << leftHandDistance << " meters" << std::endl;
                                    std::cout << "Right Hand Distance: " << rightHandDistance << " meters" << std::endl;
                                }
